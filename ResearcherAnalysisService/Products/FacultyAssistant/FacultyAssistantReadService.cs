...
public sealed class FacultyAssistantReadService(AnalysisDbContext database,
    IOptions<ArticleSummaryAutomationOptions>? analysisOptions = null)
{
    ...
    internal static async Task<bool> HasAssociationsAsync(AnalysisDbContext database, FacultyAssistantRun run,
    ...
    internal static async Task<FacultyAssistantRunResponse> MapAsync(AnalysisDbContext database,
