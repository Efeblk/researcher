...
public sealed class TableSchemaGroupingMigrationTests(SqlServerFixture fixture)
{
    ...
    private static async Task AssertExpectedTablesAsync(SqlConnection connection)
    {
        ...
        [
            ...
            "analysis.ArticleEvaluationWorkItems",
            "analysis.ArticleReviewStageCheckpoints", "analysis.ArticleReviewWorkItems",
            "analysis.ArticleSourcePages", "analysis.ArticleSourceSnapshots", "analysis.ArticleSourceSpans",
            ...
            "core.AcademicWorkTopics", "core.CanonicalResearcherWorks",
            "core.CanonicalWorkObservations", "core.CanonicalWorks", "core.PublicationDisplayApprovals",
            "core.PublicationSummaries", "core.Researchers", "crossref.CrossrefWorks",
            "faculty.AssistantContextVersions", "faculty.AssistantRuns",
