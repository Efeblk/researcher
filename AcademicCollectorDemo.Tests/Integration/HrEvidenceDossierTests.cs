...
public sealed class HrEvidenceDossierTests(SqlServerFixture fixture)
{
    [Fact]
    public async Task CreateAndActions_ContentChangeChangesFingerprintAndWhitespaceRetryIsIdempotent()
    {
        ...
        database.AddRange(researcher, academic, canonical); await database.SaveChangesAsync();
        ...
        observation.PublicationYearObserved = 2024; await database.SaveChangesAsync();
