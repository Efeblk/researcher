...
public sealed class ArticleEvaluationMigrationTests(SqlServerFixture fixture)
{
    [Fact]
    ...
    {
        using IServiceScope scope = fixture.Services.CreateScope();
        scope.ServiceProvider.GetRequiredService<IMigrationRunner>().MigrateDown(202609110009);
    }
