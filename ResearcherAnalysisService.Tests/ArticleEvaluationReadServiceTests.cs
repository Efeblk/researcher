...
using ApiContracts = ResearcherAnalysisService.Products.Api.Contracts;
using ResearcherAnalysisService.Products.ProductAccess;

namespace ResearcherAnalysisService.Tests;

[Collection("Analysis Product SQL Server")]
public sealed class ArticleEvaluationReadServiceTests(AnalysisProductSqlServerFixture fixture)
{
    [Fact]
    ...
    private static async Task CleanupAsync(AnalysisDbContext database, params Guid[] runIds)
    {
