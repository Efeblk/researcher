...
namespace AcademicCollectorDemo.Modules.AcademicPerformance.GraphProjection;

public sealed class AcademicGraphProjectionService(AcademicDbContext database)
{
