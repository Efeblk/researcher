...
public sealed class AcademicDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<ArticleSummaries.ArticleSourceSnapshot>(entity =>
        {
            ...
            entity.HasOne(snapshot => snapshot.CanonicalWork).WithMany()
                .HasForeignKey(snapshot => snapshot.CanonicalWorkId).OnDelete(DeleteBehavior.NoAction);
        });
        ...
        modelBuilder.Entity<ArticleSummaries.CanonicalArticleAnalysisRun>(entity =>
        {
            ...
            entity.HasOne(run => run.CanonicalWork).WithMany()
                .HasForeignKey(run => run.CanonicalWorkId).OnDelete(DeleteBehavior.NoAction);
        ...
        modelBuilder.Entity<ArticleSummaries.ArticleSummaryAutomationJob>(entity =>
        {
            ...
            entity.HasOne(job => job.CanonicalWork).WithMany()
                .HasForeignKey(job => job.CanonicalWorkId).OnDelete(DeleteBehavior.Cascade);
        ...
        modelBuilder.Entity<CanonicalArticleReviewRun>(entity =>
        {
            ...
            entity.HasOne(run => run.CanonicalWork).WithMany().HasForeignKey(run => run.CanonicalWorkId)
        ...
        modelBuilder.Entity<ArticleReviewWorkItem>(entity =>
        {
            ...
            entity.HasOne(value => value.CanonicalWork).WithMany().HasForeignKey(value => value.CanonicalWorkId)
                .OnDelete(DeleteBehavior.NoAction);
        ...
        modelBuilder.Entity<PublicationMetricSnapshot>(entity =>
        {
            ...
            entity.HasOne(snapshot => snapshot.Researcher).WithMany()
                .HasForeignKey(snapshot => snapshot.PersonelId).OnDelete(DeleteBehavior.NoAction);
        });
        ...
        modelBuilder.Entity<PublicationMetricsRefreshState>(entity =>
        {
            ...
            entity.HasOne(state => state.Researcher).WithOne()
                .HasForeignKey<PublicationMetricsRefreshState>(state => state.PersonelId)
                .OnDelete(DeleteBehavior.Cascade);
        ...
        modelBuilder.Entity<HrEvidenceDossier>(entity =>
        {
            ...
            entity.HasIndex(value => new { value.PersonelId, value.Id }).IsDescending(false, true);
            entity.HasOne<Researchers.Models.Researcher>().WithMany().HasForeignKey(value => value.PersonelId)
                .OnDelete(DeleteBehavior.NoAction);
