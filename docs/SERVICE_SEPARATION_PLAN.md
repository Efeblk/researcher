...
| `202609140002` | `core.CollectionChanges`; mevcut normalize veriler için başlangıç `ResearcherCollected` / `CanonicalWorkChanged` sinyalleri |
...
| `202609140002` | `analysis`, `hr`, `faculty` şemalarını oluşturur/benimser, legacy tabloları aktarır ve dış kaynak foreign key'lerini kaldırır |
