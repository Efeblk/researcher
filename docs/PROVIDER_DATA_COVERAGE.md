...
| Google Scholar | Herkese açık profil HTML'i, toplam ve son dönem atıf/h-index/i10-index değerleri ile dinamik son dönem başlangıç yılı. | Profil metrikleri; bu akışla yeni yayın veya belge sayısı üretilmez. Önceden kaydedilmiş yayınlar korunur. | Google Scholar'ın resmî API'si yoktur. Tek profil isteği yapılır; yayın sayfalaması ve CAPTCHA aşma uygulanmaz. Engel veya eksik tablo tam hata sayılır ve kısmi metrik yazılmaz. |
